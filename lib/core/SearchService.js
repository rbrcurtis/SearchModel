...
exports.search = exports.SearchService = exports.VersionConflictError = exports.SearchError = void 0;
    ...
    async executeRequest(method, path, data, attempt = 1) {
        ...
        try {
            ...
            if (response.status === 429 && attempt <= this.config.maxRetries) {
                ...
                (0, logging_1.logWarn)(`Rate limited (429). Retrying in ${delayMs}ms... (attempt ${attempt}/${this.config.maxRetries})`);
            ...
            if (attempt <= this.config.maxRetries) {
                ...
                (0, logging_1.logWarn)(`Request failed: ${error}. Retrying in ${delayMs}ms... (attempt ${attempt}/${this.config.maxRetries})`);
                await this.delay(delayMs);
                return this.executeRequest(method, path, data, attempt + 1);
            }
