...
describe('SearchService', () => {
    ...
    describe('searchRequest', () => {
        ...
        it('should handle 404 errors', async () => {
            ...
            await expect(searchService.searchRequest('GET', '/test-index/_doc/123')).rejects.toThrow(SearchService_1.SearchError);
        });
        it('should handle version conflict errors', async () => {
            ...
            await expect(searchService.searchRequest('PUT', '/test-index/_doc/123', {})).rejects.toThrow(SearchService_1.VersionConflictError);
        });
    ...
    describe('getById', () => {
        ...
        it('should throw error when indexName not defined', async () => {
            ...
            await expect(searchService.getById(NoIndexModel, (0, id_1.id)())).rejects.toThrow('IndexName not defined');
        });
    });
