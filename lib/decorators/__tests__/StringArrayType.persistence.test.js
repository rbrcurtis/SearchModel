...
class TestStringArrayModel extends SearchModel_1.SearchModel {
}
TestStringArrayModel.indexName = 'test-stringarray-index';
__decorate([
    (0, index_1.StringArrayType)({ required: true }),
    __metadata("design:type", Array)
], TestStringArrayModel.prototype, "requiredTags", void 0);
__decorate([
    (0, index_1.StringArrayType)(),
    __metadata("design:type", Array)
], TestStringArrayModel.prototype, "optionalCategories", void 0);
__decorate([
    (0, index_1.StringArrayType)({ default: () => ['default1', 'default2'] }),
    __metadata("design:type", Array)
...
describe('StringArrayType Persistence', () => {
    describe('Elasticsearch Mapping', () => {
        it('should generate correct mapping for stringArray fields', () => {
            const mapping = SearchModel_1.SearchModel.generateMapping.call(TestStringArrayModel);
